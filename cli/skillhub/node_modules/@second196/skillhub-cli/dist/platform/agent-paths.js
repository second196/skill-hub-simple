...
export function userSkillStoreRoot() {
...
export async function installedAgentTargets() {
    const existing = [];
    ...
    if (codexPath)
        existing.push({ agent: 'codex', path: codexPath });
...
export async function exposeSkillToAgent(source, target, slug) {
